...
satisfiedBOM.getOne(mapper).get().getComponent()
            ...
            new StdMachineEngine<org.elasticsearch.client.Client>(Name.of(org.elasticsearch.client.Client.class, "client"), BoundlessComponentBox.FACTORY) {
                ...
                @Override
                public org.elasticsearch.client.Client doNewComponent(SatisfiedBOM satisfiedBOM) {
