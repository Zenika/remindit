...
import it.remind.rest.HelloResourceRouter;
...
private final Factory.Query<it.remind.rest.HelloResource> resource = Factory.Query.byClass(it.remind.rest.HelloResource.class).mandatory();
